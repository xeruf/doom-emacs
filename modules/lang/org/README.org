...
+ =+noter= Enables [[https://github.com/weirdNox/org-noter][org-noter]] integration. Keeps notes in sync with a document.
...
+ =+roam= Enables [[https://github.com/org-roam/org-roam][org-roam]] integration. This requires ~sqlite3~ to be installed
  on your system.
